...
Visit number can be interpretted as: For each additional follow up visit, we expect a .242 decrease in cd4 percentage on average, all else equal. 
...
```{r, message = FALSE}
#use same model as above but with date as a factor and date does not vary by personid
